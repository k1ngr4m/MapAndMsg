package com.example.mapandmsg.adapter.pictureselector;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                viewHolder.ivSelectPic.setImageResource(com.luck.picture.lib.R.drawable.pic_audio_placeholder);
            } else {
                RequestOptions options = new RequestOptions()
                        .centerCrop()
                        .placeholder(com.luck.picture.lib.R.color.picture_color_f2)
