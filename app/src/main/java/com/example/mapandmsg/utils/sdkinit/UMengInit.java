...
package com.example.mapandmsg.utils.sdkinit;
...
public final class UMengInit {
    ...
    public static void init(Application application) {
        ...
        UMConfigure.preInit(application, BuildConfig.APPLICATION_ID, getChannel(application));
        // 用户同意了隐私协议
    ...
    private static void realInit(Application application) {
        ...
        UMConfigure.init(application, BuildConfig.APPLICATION_ID, getChannel(application), UMConfigure.DEVICE_TYPE_PHONE, "");
